...
def main():  # noqa: D103
    ...
    # get exact block where each fork activated on fusaka-devnet-4, and each block before this (except block before osaka)  # noqa: E501

    # observe the following block header values:
    #   -     base_fee_per_gas
    #   -     blob_gas_used
    #   -     excess_blob_gas
...
"""
Overview of relevant devnet-4 header values of fork activation blocks and the blocks right before them:

Osaka:
{
    'baseFeePerGas' :	'0x7'
    'blobGasUsed'   :	'0x100000'
    'excessBlobGas' :	'0x37c0000'
    'timestamp'     :	'0x689736fc'
    'blockId'       :	'0x2000'
}
...
Slot before BPO2:
{
    ...
    'excessBlobGas' :   '0x8fc202'
    'timestamp'     :   '0x689a879c'
    'blockId'       :   '0x5fff'
}
...
BPO2:
{
    'baseFeePerGas' :   '0x1a'
    'blobGasUsed'   :   '0xe0000'
    'excessBlobGas' :   '0x97c202'
    'timestamp'     :   '0x689a87a8'
    'blockId'       :   '0x6000'
}
...
{
    'baseFeePerGas' :	'0x8'
    'blobGasUsed'   :	'0x1c0000'
    'excessBlobGas' :	'0x0'
    'timestamp'     :	'0x689f2044'
    'blockId'       :	'0x9fff'
}
...
{
    'baseFeePerGas' :	'0x8'
    'blobGasUsed'   :	'0x3a0000'
    'excessBlobGas' :	'0x0'
    'timestamp'     :	'0x689f2050'
    'blockId'       :	'0xa000'
}

BPO5:
-> remote endpoint does not have this data/block or not synced yet
-> don't know why, it should be available we are at block 32810 (0x802A < 0xC000)
